...
const sprints = [
  ...
  { number: 2, name: 'Estacionamientos + Zonas', icon: '⏳', statusLabel: 'Siguiente', statusClass: 'bg-blue-500/20 text-blue-400' },
  { number: 3, name: 'Puestos (~1.000)', icon: '🔲', statusLabel: 'Pendiente', statusClass: 'bg-slate-500/20 text-slate-400' },
  { number: 4, name: 'Mapa Visual SVG', icon: '🔲', statusLabel: 'Pendiente', statusClass: 'bg-slate-500/20 text-slate-400' },
  { number: 5, name: 'Check-in / Check-out', icon: '🔲', statusLabel: 'Pendiente', statusClass: 'bg-slate-500/20 text-slate-400' },
];
